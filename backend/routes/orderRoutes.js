        ...
        for (let i = 0; i < newOrder.orderItems.length; i++) {
            ...
            User.findOne({ id: userID }, function(err, user) {
                ...
                const mailOptions = {
                    ...
                    html: `
<div style="max-width: 700px; margin:auto; border: 10px solid red; padding: 50px 20px; font-size: 110%;">
      <h2 style="text-align: center; text-transform: uppercase;color: blue;">Cám ơn bạn đã đặt hàng tại Đức Phúc!.</h2>
